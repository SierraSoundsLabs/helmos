...
export const metadata: Metadata = {
  ...
  // PWA / iOS web-clip metadata. The manifest itself is generated by
  // app/manifest.ts and served at /manifest.webmanifest — Next.js auto-
  // links it; we don't need a manual <link rel="manifest"> here.
  appleWebApp: {
    capable: true,
    title: "Helm",
...
// Viewport-color metadata is split out from `metadata` per Next 15 rules.
// theme-color matches the brand indigo and tints the iOS status bar /
// Android navigation bar when the PWA is installed.
  ...
  return (
    <html lang="en">
      ...
      <body className={`${inter.variable} font-sans antialiased`}>
        ...
        <Analytics />
        {/* Registers /sw.js so helmos.co is installable as a PWA and is
            ready to receive Web Push (wired in PR B). Renders nothing. */}
